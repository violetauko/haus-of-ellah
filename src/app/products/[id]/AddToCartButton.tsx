...
export default function AddToCartButton({ product }: AddToCartButtonProps) {
  ...
  <button
    ...
    className={`flex-1 py-4 rounded-lg font-bold transition flex items-center justify-center gap-2 ${
      justAdded
  ...
  <Link href="/cart" className="flex-1">
    <button
      className="w-full border-2 text-black hover:bg-stone-100 py-4 rounded-lg font-bold transition flex items-center justify-center gap-2"
    >
      <ShoppingBag size={24} />
      <span>Cart</span>
    </button>
